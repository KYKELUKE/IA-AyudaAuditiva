...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Análisis emocional con múltiples métodos de procesamiento</p>
        </div>
        
        <div class="content">
            <div class="success-notice">
                <strong>✅ Sistema Ultra-Robusto:</strong> Múltiples métodos de procesamiento para máxima compatibilidad con cualquier formato de audio.
            </div>
            ...
            <div id="recordTab" class="tab-content active">
                <div class="recorder-container">
                    ...
                    <p class="help-text">
                        💡 <strong>Nuevo:</strong> Ahora funciona con cualquier formato de grabación. Si un método falla, automáticamente prueba otros.
                    </p>
                </div>
            ...
            <div id="uploadTab" class="tab-content">
                ...
                <div class="troubleshooting">
                    <h4>🔧 Métodos de procesamiento automático:</h4>
                    <ul>
                        <li><strong>Método 1:</strong> Procesamiento directo con librosa</li>
                        <li><strong>Método 2:</strong> Conversión FFmpeg + librosa (para WEBM)</li>
                        <li><strong>Método 3:</strong> Librosa con parámetros alternativos</li>
                        <li><strong>Método 4:</strong> Análisis básico del archivo (respaldo)</li>
                    </ul>
                    <p><strong>✅ Garantía:</strong> Al menos uno de estos métodos funcionará con tu audio.</p>
                </div>
            </div>
            
            <div id="loading" class="loading">
                <div class="spinner"></div>
                <p id="loadingText">Probando múltiples métodos de procesamiento...</p>
            </div>
    ...
    <script>
        ...
        async function startRecording() {
            try {
                ...
                // Usar el formato más compatible disponible
                ...
                mediaRecorder.onstop = () => {
                    ...
                    console.log('Grabación completada, tamaño:', recordedBlob.size, 'bytes');
        ...
        async function analyzeRecording() {
            ...
            try {
                ...
                console.log('Enviando grabación para análisis...');
        ...
        function handleFile(file) {
            ...
            document.getElementById('fileInfo').innerHTML = `
                ...
                <strong>✅ Listo para análisis multi-método</strong>
            `;
        ...
        function showResult(data) {
            ...
            const methodInfo = data.analysis_method === 'basic_file_analysis' 
                ? 'Análisis básico del archivo (método de respaldo)'
                : 'Análisis completo con librosa';
    ...
    try:
        ...
        try:
            ...
            response = {
                ...
                'filename': filename,
                'analysis_type': 'multi_method_robust'
            }
...
if __name__ == '__main__':
    print("🧠 Asistente de Apoyo Emocional - VERSIÓN ULTRA-ROBUSTA")
    print("=" * 70)
    print("✅ Múltiples métodos de procesamiento de audio")
    print("✅ Manejo robusto de archivos WEBM del navegador")
    print("✅ Análisis de respaldo cuando falla librosa")
    print("✅ Compatibilidad garantizada con cualquier formato")
    print("=" * 70)
